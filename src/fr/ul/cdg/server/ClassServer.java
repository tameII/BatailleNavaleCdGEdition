...
/**
 * server.ClassServer is an abstract class that provides the
 * basic functionality of a mini-webserver, specialized
 * to load class files only. A server.ClassServer must be extended
 * and the concrete subclass should define the <b>getBytes</b>
 * method which is responsible for retrieving the bytecodes
 * for a class.<p>
 *
 * The server.ClassServer creates a thread that listens on a socket
...
public abstract class ClassServer implements Runnable {
    ...
    /**
     * Constructs a server.ClassServer that listens on <b>port</b> and
     * obtains a class's bytecodes using the method <b>getBytes</b>.
     *
     * @param port the port number
     * @exception IOException if the server.ClassServer could not listen
     *            on <b>port</b>.
     */
